...
import { IonicStyleUtilModel } from '../utils/ionic-style-util.model';

export class FormFieldModel extends IonicStyleUtilModel {
	type: EnumFormType;
	...
	get sizeGroupCol(): object {
		return IonicStyleUtils.getSize(this.sizeGroup);
	}
