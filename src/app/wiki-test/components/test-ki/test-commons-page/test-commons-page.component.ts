...
@Component({
	selector: 'wiki-test-commons-page',
	templateUrl: './test-commons-page.component.html',
	styleUrls: ['./test-commons-page.component.scss'],
})
export class TestCommonsPageComponent implements OnInit {
