...
@Component({
	selector: 'wiki-test-table-list',
	templateUrl: './test-table-list.component.html',
	styleUrls: ['./test-table-list.component.scss'],
})
export class TestTableListComponent extends BaseSearchComponent<ProvaPaginationModel> {
	validations: any;
